...
public record HandshakePacket(int protocolVersion, @NotNull String serverAddress,
                              int serverPort, int nextState) implements JavaClientPacket {
     ...
     */
    private static final Component INVALID_VERSION_TEXT = Component.text("Invalid Version, please use " + Meld.INSTANCE.getJavaVersion(), NamedTextColor.RED);
...
//        connection.sendPacket(new LoginDisconnectPacketJava(reason));

...
public record LoginSuccessPacketJava(@NotNull UUID uuid, @NotNull String username, int properties) implements JavaServerPacket {
    public LoginSuccessPacketJava(@NotNull NetworkBuffer reader) {

...
public record LoginPluginResponsePacket(int messageId, byte @Nullable [] data) implements JavaClientPacket {
...
//                } else {
//                    LoginDisconnectPacketJava disconnectPacket = new LoginDisconnectPacketJava(INVALID_PROXY_RESPONSE);

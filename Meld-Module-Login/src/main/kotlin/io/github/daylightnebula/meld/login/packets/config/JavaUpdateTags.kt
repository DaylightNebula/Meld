    ...
    override fun encode(writer: ByteWriter) {
        ...
        tags.forEach { k, v ->
            ...
            array.forEach { e ->
                ...
                val entries = entry["entries"]!!.jsonArray
                writer.writeString(entry["tag_name"]!!.jsonObject["raw_string"]!!.jsonPrimitive.content)
                writer.writeVarInt(entries.size)
                entries.forEach { writer.writeVarInt(it.jsonPrimitive.int) }
            }
        }
    }

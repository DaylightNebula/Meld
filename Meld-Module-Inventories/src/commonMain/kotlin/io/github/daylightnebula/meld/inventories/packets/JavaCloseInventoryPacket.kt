...
class JavaCloseInventoryPacket(
    ...
    companion object: JavaPacket.Creator<JavaCloseInventoryPacket> {
        override val INCOMING_ID: Int = 0x11
        override val STATE: JavaConnectionState = JavaConnectionState.IN_GAME
        override fun create() = JavaCloseInventoryPacket()
    }

    override val OUTGOING_ID: Int = 0x11
